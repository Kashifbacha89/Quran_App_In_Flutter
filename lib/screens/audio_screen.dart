  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text('Now Playing',style:GoogleFonts.aBeeZee(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                         Text('UPCOMING SURAH',style: GoogleFonts.aBeeZee(
                      textStyle: const TextStyle(
                        ...
                        Visibility(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              const Icon(Icons.play_circle_fill,color: Constants.myPrimary,),
                        ...
                        Visibility(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Icon(currentIndex>111 ? null :Icons.play_circle_fill,color: Constants.myPrimary,),
      ...
      children: [
        SliderTheme(
          data: SliderTheme.of(context).copyWith(
            activeTrackColor: Constants.myPrimary,
            inactiveTrackColor: Colors.grey,
            trackHeight: 5.0,
            thumbColor: Constants.myPrimary,
